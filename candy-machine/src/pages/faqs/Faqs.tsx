...
function Faqs() {
    return (
          <section id="faqs-section" className="faq">
            <div className="rows">
              <h2 className="team-heading">// FAQs</h2>
            </div>
              <div className="rows">
              ...
              <div className="rows">
                ...
                <div className="faq-item">
                  ...
                  <p>The digital art will be stored on Arweave, a decentralized data storage that backs data with sustainable and perpetual endowments, allowing users and developers to truly store data forever.</p>
                </div>
              </div>
              <div className="rows">
                <div className="faq-item">
